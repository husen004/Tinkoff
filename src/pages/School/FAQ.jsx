...
import { schoolFAQ } from '../../constants'
    ...
    <div>
      <div className='flex justify-center my-10 mx-2'>
        <div className='flex flex-col justify-evenly bg-white rounded-3xl px-12'>
          {schoolFAQ.map((s, i) => (
            <div className='w-full border-b border-gray-300 cursor-pointer my-4  mx-6' key={i} >
                <div className='flex flex-row justify-between transition ease-in hover:opacity-60' onClick={() => handleOpen(i)}>
                <h4 className='font-bold md:text-[23px] text-[14px] transition ease-in hover:opacity-60 '>{s.title}</h4>
                <div className={`pr-8`}>
