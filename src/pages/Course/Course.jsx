  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex flex-wrap justify-center items-center gap-10 my-14 mx-4'>
        ...
        <div className='relative flex flex-col justify-center items-center text-center transition ease-in-out duration-500 md:hover:scale-105 cursor-pointer bg-white rounded-3xl shadow-lg'>
        ...
        <div className='relative flex flex-col justify-center items-center text-center transition ease-in-out md:hover:scale-105 duration-500 cursor-pointer bg-white rounded-3xl shadow-lg'>
