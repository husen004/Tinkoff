  ...
  return (
    ...
    <div className='bg-white flex md:justify-evenly justify-between items-center flex-row py-4 m-auto'>
      ...
      <ul className='md:gap-4 gap-2 md:flex hidden text-xs text-gray-500'>
          <li><Link to='/school' className=' hover:text-gray-700'>Школьникам</Link></li>
          <li><Link to='/course' className=' hover:text-gray-700'>Финтех курсы</Link></li>
          <li><Link to='/intern' className=' hover:text-gray-700'>Стажировка</Link></li>
          <li><Link to='/uni' className=' hover:text-gray-700'>Проекты в вузых</Link></li>
          <li><Link to='/poko' className=' hover:text-gray-700'>Вклад в поколение</Link></li>
          <li><Link to='/event' className=' hover:text-gray-700'>Мероприятние</Link></li>
          <li><Link to='/career' className=' hover:text-gray-700'>Карьера</Link></li>
          <li><Link to='/zero' className=' hover:text-gray-700'>С нуля</Link></li>
        </ul>
      </div>
      <div className='md:flex hidden'>
      <li className='text-yellow-400 hover:text-yellow-600 cursor-pointer list-none'><Link to='/register'>Вход</Link></li>
      </div>
